...
export default function ManageItems() {
  ...
  const addItem = async () => {
    ...
    const { error } = await supabase.from("phoolbook_items")
  ...
  const deleteItem = async (id) => {
    ...
    await supabase.from("phoolbook_items").delete().eq("id", id).eq("user_id", session.user.id);
  ...
  const addVariant = async () => {
    ...
    const { error } = await supabase.from("phoolbook_variants").insert([{
  ...
  const deleteVariant = async (id) => {
    ...
    await supabase.from("phoolbook_variants").delete().eq("id", id).eq("user_id", session.user.id);
